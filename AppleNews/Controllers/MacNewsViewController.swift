...
class MacTableViewController: UITableViewController, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
       ...
       // view.backgroundColor = .none
        ...
        let urlCall = mainVC.networkManager.updateDateForAPICall(appleProduct: NetworkManager.queryType.mac.rawValue, date: mainVC.networkManager.currentDate)
