...
class iPadTableViewController: UITableViewController, UISearchBarDelegate, UISearchResultsUpdating {
    //make sure this class conforms to UISearchResultsUpdating Protocol otherwise weird errors pop up
    ...
    override func viewDidLoad() {
       ...
       // view.backgroundColor = .none
        ...
        let urlCall = mainVC.networkManager.updateDateForAPICall(appleProduct: NetworkManager.queryType.iPad.rawValue, date: mainVC.networkManager.currentDate)
