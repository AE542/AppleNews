...
class WatchTableViewController: UITableViewController, UISearchBarDelegate, UISearchResultsUpdating{
    //DUH! Should be a UITableViewController not a regular VC! This is why it was loading a black view with nothing in it!
    ...
    override func viewDidLoad() {
       ...
       // view.backgroundColor = .none
        navigationItem.title = "Watch News"
        ...
        let urlCall = mainVC.networkManager.updateDateForAPICall(appleProduct: NetworkManager.queryType.watch.rawValue, date: mainVC.networkManager.currentDate)
        
        let url = URL(string: urlCall)
        
        //let downArrow = UIImage(named: "arrow.down")
//            let imageAttachment = NSTextAttachment()
//            imageAttachment.image = UIImage(systemName: "arrow.down")?.withTintColor(.blue)
        ...
        mainVC.searchController.searchResultsUpdater = self

        //navigationItem.titleView = mainVC.searchBar
        ...
        guard url != nil else {
            ...
            if error == nil && data != nil { //if no errors and data is not equal to nil
                let decoder = JSONDecoder() //decode data from NewsArticles
...
//                    self.present(ac, animated: true, completion: nil)
            ...
            DispatchQueue.main.async { //SYNC UI WORK ON THE MAIN THREAD!!
                ...
                //mainVC.tableView isn't loading data.
            }
            //self.tableView.reloadData()
        }
        //make API call, you must call this each time you make a data call to the API
        dataTask.resume()
    ...
    @objc func refresh(_ sender: AnyObject) {
        ...
        let urlCall = networkManager.updateDateForAPICall(appleProduct: NetworkManager.queryType.watch.rawValue, date: networkManager.currentDate)
